jQuery(document).ready( function($) {
    ...
    if (jQuery(".rwmb-input input[value='tabs'][name='vbegy_tabs_type']:checked").length > 0 && jQuery(".rwmb-input input[value='categories'][name='vbegy_tabs_type']:checked").length == 0) {
    	jQuery("label[for='vbegy_what_tab']").parent().parent().slideDown(500);
    	jQuery("label[for='vbegy_sort_home_elements']").parent().parent().slideDown(500);
    	jQuery("label[for='vbegy_categories_show']").parent().parent().hide(10);
    }else {
    	jQuery("label[for='vbegy_what_tab']").parent().parent().hide(10);
    	jQuery("label[for='vbegy_sort_home_elements']").parent().parent().slideUp(500);
    	jQuery("label[for='vbegy_categories_show']").parent().parent().slideDown(500);
    }
    jQuery(".rwmb-input input[value='categories'][name='vbegy_tabs_type']").click(function () {
    	jQuery("label[for='vbegy_what_tab']").parent().parent().slideUp(500);
    	jQuery("label[for='vbegy_sort_home_elements']").parent().parent().slideUp(500);
    	jQuery("label[for='vbegy_categories_show']").parent().parent().slideDown(500);
    });
    jQuery(".rwmb-input input[value='tabs'][name='vbegy_tabs_type']").click(function () {
    	jQuery("label[for='vbegy_what_tab']").parent().parent().slideDown(500);
    	jQuery("label[for='vbegy_sort_home_elements']").parent().parent().slideDown(500);
    	jQuery("label[for='vbegy_categories_show']").parent().parent().slideUp(500);
    });
});