...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => 'Show the free coupons when add a new question?',
	...
	$options[] = array(
		...
		'std' => 'Copyright 2016 Ask me | <a href=http://2code.info/>By 2code</a>',
		'type' => 'textarea');
	...
	$options[] = array(
		'name' => 'Click ON to create all theme pages (20 pages)',
		'desc' => 'Click ON to create all theme pages (20 pages)',
		'id' => 'theme_pages',
		'std' => 0,
		'type' => 'checkbox');
